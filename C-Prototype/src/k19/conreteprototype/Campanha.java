package k19.conreteprototype;

import java.text.SimpleDateFormat;
import java.util.Calendar;
import java.util.Set;

import k19.prototype.Prototype;

/**
 * Classe que define um tipo particular de objeto que pode ser clonado.
 */
public class Campanha extends Prototype<Campanha> {
	private String nome;
	...
	//criei para testar alteração simultânea dos dois objetos (original e clone)
